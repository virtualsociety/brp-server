...
namespace Brp.Api
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.7.0.0 (NJsonSchema v10.1.24.0 (Newtonsoft.Json v11.0.0.0))")]
    [Microsoft.AspNetCore.Mvc.Route("VNGRealisatie/api/bevragingen_ingeschreven_personen")]
    public partial class Controller : ControllerBase
    {
        ...
        public System.Threading.Tasks.Task<IngeschrevenPersoonHalCollectie> IngeschrevenNatuurlijkPersonen([Microsoft.AspNetCore.Mvc.FromQuery] string expand, [Microsoft.AspNetCore.Mvc.FromQuery] string fields, [Microsoft.AspNetCore.Mvc.FromQuery] System.Collections.Generic.IEnumerable<string> burgerservicenummer, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? geboorte__datum, [Microsoft.AspNetCore.Mvc.FromQuery] string geboorte__plaats, [Microsoft.AspNetCore.Mvc.FromQuery] Geslacht_enum? geslachtsaanduiding, [Microsoft.AspNetCore.Mvc.FromQuery] bool? inclusiefoverledenpersonen, [Microsoft.AspNetCore.Mvc.FromQuery] string naam__geslachtsnaam, [Microsoft.AspNetCore.Mvc.FromQuery] string naam__voornamen, [Microsoft.AspNetCore.Mvc.FromQuery] string verblijfplaats__gemeentevaninschrijving, [Microsoft.AspNetCore.Mvc.FromQuery] string verblijfplaats__huisletter, [Microsoft.AspNetCore.Mvc.FromQuery] int? verblijfplaats__huisnummer, [Microsoft.AspNetCore.Mvc.FromQuery] string verblijfplaats__huisnummertoevoeging, [Microsoft.AspNetCore.Mvc.FromQuery] string verblijfplaats__identificatiecodenummeraanduiding, [Microsoft.AspNetCore.Mvc.FromQuery] string verblijfplaats__naamopenbareruimte, [Microsoft.AspNetCore.Mvc.FromQuery] string verblijfplaats__postcode, [Microsoft.AspNetCore.Mvc.FromQuery] string naam__voorvoegsel)
        {
            return _implementation.IngeschrevenNatuurlijkPersonenAsync(expand, fields, burgerservicenummer, geboorte__datum, geboorte__plaats, geslachtsaanduiding, inclusiefoverledenpersonen, naam__geslachtsnaam, naam__voornamen, verblijfplaats__gemeentevaninschrijving, verblijfplaats__huisletter, verblijfplaats__huisnummer, verblijfplaats__huisnummertoevoeging, verblijfplaats__identificatiecodenummeraanduiding, verblijfplaats__naamopenbareruimte, verblijfplaats__postcode, naam__voorvoegsel);
        }
        ...
        public System.Threading.Tasks.Task<IngeschrevenPersoonHal> IngeschrevenNatuurlijkPersoon(string burgerservicenummer, [Microsoft.AspNetCore.Mvc.FromQuery] string expand, [Microsoft.AspNetCore.Mvc.FromQuery] string fields)
        {
            return _implementation.IngeschrevenNatuurlijkPersoonAsync(burgerservicenummer, expand, fields);
        }

        /// <param name="id">De identificatie van het kind.</param>
        /// <returns>Zoekactie geslaagd</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("ingeschrevenpersonen/{burgerservicenummer}/kinderen/{id}")]
        public System.Threading.Tasks.Task<KindHal> IngeschrevenpersonenBurgerservicenummerkinderenId(string burgerservicenummer, string id)
        {
            return _implementation.IngeschrevenpersonenBurgerservicenummerkinderenIdAsync(burgerservicenummer, id);
        }

        /// <returns>Zoekactie geslaagd</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("ingeschrevenpersonen/{burgerservicenummer}/kinderen")]
        public System.Threading.Tasks.Task<KindHalCollectie> IngeschrevenpersonenBurgerservicenummerkinderen(string burgerservicenummer)
        {
            return _implementation.IngeschrevenpersonenBurgerservicenummerkinderenAsync(burgerservicenummer);
        }

        /// <param name="id">De identificatie van de ouder.</param>
        /// <returns>Zoekactie geslaagd</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("ingeschrevenpersonen/{burgerservicenummer}/ouders/{id}")]
        public System.Threading.Tasks.Task<OuderHal> IngeschrevenpersonenBurgerservicenummeroudersId(string burgerservicenummer, string id)
        {
            return _implementation.IngeschrevenpersonenBurgerservicenummeroudersIdAsync(burgerservicenummer, id);
        }

        /// <returns>Zoekactie geslaagd</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("ingeschrevenpersonen/{burgerservicenummer}/ouders")]
        public System.Threading.Tasks.Task<OuderHalCollectie> IngeschrevenpersonenBurgerservicenummerouders(string burgerservicenummer)
        {
            return _implementation.IngeschrevenpersonenBurgerservicenummeroudersAsync(burgerservicenummer);
        }

        /// <param name="id">De identificatie van de partner.</param>
        /// <returns>Zoekactie geslaagd</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("ingeschrevenpersonen/{burgerservicenummer}/partners/{id}")]
        public System.Threading.Tasks.Task<PartnerHal> IngeschrevenpersonenBurgerservicenummerpartnersId(string burgerservicenummer, string id)
        {
            return _implementation.IngeschrevenpersonenBurgerservicenummerpartnersIdAsync(burgerservicenummer, id);
        }

        /// <returns>Zoekactie geslaagd</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("ingeschrevenpersonen/{burgerservicenummer}/partners")]
        public System.Threading.Tasks.Task<PartnerHalCollectie> IngeschrevenpersonenBurgerservicenummerpartners(string burgerservicenummer)
        {
            return _implementation.IngeschrevenpersonenBurgerservicenummerpartnersAsync(burgerservicenummer);
        }
        ...
        /// <param name="datumtotenmet">De einddatum van de periode waarover de resource wordt opgevraagd.</param>
        /// <returns>Zoekactie geslaagd</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("ingeschrevenpersonen/{burgerservicenummer}/verblijfplaatshistorie")]
        public System.Threading.Tasks.Task<VerblijfplaatshistorieHalCollectie> Getverblijfplaatshistorie(string burgerservicenummer, [Microsoft.AspNetCore.Mvc.FromQuery] string fields, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? peildatum, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? datumvan, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? datumtotenmet)
        {
            return _implementation.GetverblijfplaatshistorieAsync(burgerservicenummer, fields, peildatum, datumvan, datumtotenmet);
        }
        ...
        /// <param name="datumtotenmet">De einddatum van de periode waarover de resource wordt opgevraagd.</param>
        /// <returns>Zoekactie geslaagd</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("ingeschrevenpersonen/{burgerservicenummer}/partnerhistorie")]
        public System.Threading.Tasks.Task<PartnerhistorieHalCollectie> Getpartnerhistorie(string burgerservicenummer, [Microsoft.AspNetCore.Mvc.FromQuery] string fields, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? peildatum, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? datumvan, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? datumtotenmet)
        {
            return _implementation.GetpartnerhistorieAsync(burgerservicenummer, fields, peildatum, datumvan, datumtotenmet);
        }
        ...
        /// <param name="datumtotenmet">De einddatum van de periode waarover de resource wordt opgevraagd.</param>
        /// <returns>Zoekactie geslaagd</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("ingeschrevenpersonen/{burgerservicenummer}/verblijfstitelhistorie")]
        public System.Threading.Tasks.Task<VerblijfstitelhistorieHalCollectie> Getverblijfstitelhistorie(string burgerservicenummer, [Microsoft.AspNetCore.Mvc.FromQuery] string fields, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? peildatum, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? datumvan, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? datumtotenmet)
        {
            return _implementation.GetverblijfstitelhistorieAsync(burgerservicenummer, fields, peildatum, datumvan, datumtotenmet);
        }
        ...
        /// <param name="datumtotenmet">De einddatum van de periode waarover de resource wordt opgevraagd.</param>
        /// <returns>Zoekactie geslaagd</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("ingeschrevenpersonen/{burgerservicenummer}/nationaliteithistorie")]
        public System.Threading.Tasks.Task<NationaliteithistorieHalCollectie> Getnationaliteithistorie(string burgerservicenummer, [Microsoft.AspNetCore.Mvc.FromQuery] string fields, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? peildatum, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? datumvan, [Microsoft.AspNetCore.Mvc.FromQuery] System.DateTimeOffset? datumtotenmet)
        {
            return _implementation.GetnationaliteithistorieAsync(burgerservicenummer, fields, peildatum, datumvan, datumtotenmet);
        }
    ...
    public partial class IngeschrevenPersoon
    {
        ...
        public System.Collections.Generic.List<Nationaliteit> Nationaliteit { get; set; }
        ...
        public System.Collections.Generic.List<string> Reisdocumenten { get; set; }
    ...
    public partial class IngeschrevenPersoon_embedded
    {
        ...
        [Newtonsoft.Json.JsonProperty("ouders", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.MaxLength(4)]
        public System.Collections.Generic.List<OuderHal> Ouders { get; set; }

        /// <summary>De kinderen van de ingeschreven persoon, waarnaar de KIND-OUDER-RELATIE verwijst</summary>
        [Newtonsoft.Json.JsonProperty("kinderen", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<KindHal> Kinderen { get; set; }

        /// <summary>De actuele bij de ingeschreven persoon geregistreerde huwelijken en geregistreerd partnerschappen. Een beëindigd huwelijk of geregistreerd partnerschap wordt niet teruggegeven.</summary>
        [Newtonsoft.Json.JsonProperty("partners", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<PartnerHal> Partners { get; set; }
    ...
    public partial class IngeschrevenPersoonHalCollectie__embedded
    {
        ...
        public System.Collections.Generic.List<IngeschrevenPersoonHal> Ingeschrevenpersonen { get; set; }
    ...
    {
        [Newtonsoft.Json.JsonProperty("nationaliteithistorie", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<Nationaliteithistorie> Nationaliteithistorie { get; set; }
    ...
    {
        [Newtonsoft.Json.JsonProperty("verblijfplaatshistorie", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<VerblijfplaatshistorieHal> Verblijfplaatshistorie { get; set; }
    ...
    {
        [Newtonsoft.Json.JsonProperty("partnerhistorie", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<PartnerhistorieHal> Partnerhistorie { get; set; }
    ...
    {
        [Newtonsoft.Json.JsonProperty("verblijfstitelhistorie", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<Verblijfstitelhistorie> Verblijfstitelhistorie { get; set; }
